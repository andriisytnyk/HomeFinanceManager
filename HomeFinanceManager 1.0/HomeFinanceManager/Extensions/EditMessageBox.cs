...
namespace HomeFinanceManager.Extensions
{
    public static class EditMessageBox
    {
        ...
        public static DialogResult InputBox(string fromName, string lbText, ref string value) // ++++++
        {
        ...
        public static DialogResult InputBox(ref double price, ref double count, ref DateTime date) // ++++++
        {
            #region creating controls
            ...
            lbDate.SetBounds(9, 98, 372, 13);
            cbDate.SetBounds(12, 114, 372, 20);
            ...
            form.ClientSize = new Size(396, 185);
            form.Controls.AddRange(new Control[] { lbPrice, tbPrice, lbCount, tbCount, lbDate, cbDate, buttonOk, buttonCancel });
        ...
        public static DialogResult InputBox(ref string name, ref double cost, ref double count, ref string type, ref string importance, 
                                            ref DateTime date, List<string> listType, List<string> listImportance) // ++++++
        {
            #region creating controls
            ...
            lbDay.SetBounds(32, 217, 124, 13);
            cbDay.SetBounds(35, 233, 40, 21);

            lbMonth.SetBounds(92, 217, 124, 13);
            cbMonth.SetBounds(95, 233, 90, 21);

            lbYear.SetBounds(202, 217, 124, 13);
            cbYear.SetBounds(205, 233, 50, 21);

            buttonOk.SetBounds(228, 275, 75, 23);
            buttonCancel.SetBounds(309, 275, 75, 23);
            ...
            form.ClientSize = new Size(396, 310);
            form.Controls.AddRange(new Control[] { lbName, tbName, lbCost, tbCost, lbCount, tbCount, lbType, cbType, lbImportance, cbImportance, lbDay, cbDay, lbMonth, cbMonth, lbYear, cbYear, buttonOk, buttonCancel });
            form.ClientSize = new Size(Math.Max(300, lbName.Right + 10), form.ClientSize.Height);
            form.FormBorderStyle = FormBorderStyle.FixedDialog;
            form.StartPosition = FormStartPosition.CenterScreen;
            form.MinimizeBox = false;
